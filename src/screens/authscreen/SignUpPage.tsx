    ...
    return (
        ...
        >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {[
                { label: "Continue with Google",            icon: <GoogleIcon />,    onClick: () => alert("Google signup") },
                { label: "Continue with Microsoft Account", icon: <MicrosoftIcon />, onClick: () => alert("Microsoft signup") },
                { label: "Continue with Apple",             icon: <AppleIcon />,     onClick: () => alert("Apple signup") },
